...
```{r, fig.cap="Mean annual temperature reconstruction for Tornestrask, Sweden assuming negative exponential biological growth function, a linear relationship with climate, and that climate is stable following a normal distribution.", echo=FALSE, out.width="75%"}

library(knitr)

include_graphics("Results/Figures/JAGS/negexp_norm_paper.png")
...
```{r, eval=FALSE, out.width="75%", fig.cap="Spline detrending example"}
include_graphics("Results/Figures/Detrend/Splines/detrend_tree_spl_4.png")
```

```{r, eval=FALSE, out.width="75%", fig.cap="Spline detrending example"}
include_graphics("Results/Figures/Detrend/Splines/detrend_tree_spl_240.png")
```

```{r, eval=FALSE, out.width="75%", fig.cap="Spline detrending example"}
include_graphics("Results/Figures/Detrend/Splines/detrend_tree_spl_245.png")
```

Below is the resulting reconstruction.

```{r, fig.cap="Mean annual temperature reconstruction for Tornestrask, Sweden assuming a smooth biological growth function (spline), a linear relationship with climate, and that climate is stable following a normal distribution.", echo=FALSE, out.width="75%"}

library(knitr)

include_graphics("Results/Figures/JAGS/spline_norm_paper.png")

```

### Negative Exponential with AR1

```{r, fig.cap="Mean annual temperature reconstruction for Tornestrask, Sweden assuming negative exponential biological growth function, a linear relationship with climate, and that climate is stable following a normal distribution. The model also allows for autocorrelation with the previous year (AR1).", echo=FALSE, out.width="75%"}

library(knitr)

include_graphics("Results/Figures/JAGS/negexp_linear_ar_paper.png")
...
```{r, fig.cap="Mean annual temperature reconstruction for Tornestrask, Sweden assuming negative exponential biological growth function, a linear relationship with climate, and that climate is unstable varying smoothly and estimated with a cubic B-Spline.", echo=FALSE, out.width="75%"}

library(knitr)

include_graphics("Results/Figures/JAGS/negexp_spl25_paper.png")
...
```{r, fig.cap="Mean annual temperature reconstruction for Tornestrask, Sweden assuming negative exponential biological growth function, a piecewise linear relationship with climate with an unknown change point, and that climate is stable following a normal distribution.", echo=FALSE, out.width="75%"}

library(knitr)

include_graphics("Results/Figures/JAGS/negexp_1change_paper.png")
...
```{r, fig.cap="Mean annual temperature reconstruction for Tornestrask, Sweden assuming NegExp-RCS biological growth function, a linear relationship with climate, and that climate is unstable but varies smoothly over time (estimated with a B-spline).", echo=FALSE, out.width="75%"}

library(knitr)

include_graphics("Results/Figures/JAGS/rcs_spline_25_paper.png")
...
library(knitr)
torn_stats <- read.csv("Results/torn_performance_stats.csv", header = TRUE, stringsAsFactors = FALSE)
knitr::kable(torn_stats, caption = "Summary statistics of Tornetrask held out validation data.")
```
...
```{r, fig.cap="Tree ring data from the New Mexico Southwest Climate Division (29-04).", echo=FALSE, out.width="75%"}

library(knitr)

include_graphics("Results/Figures/NM/nm_study_sites.png")
...
```{r, fig.cap="Mean Jan-July precipitation reconstruction from multispecies tree-ring data for the Southwest Mountains of New Mexico. This model assumes negative exponential biological growth, a linear climate relationship, and stably fluctuating climate (normal distribution).", echo=FALSE, out.width="75%"}

library(knitr)
include_graphics("Results/Figures/NM/negexp_norm_paper.png")
```

```{r, fig.cap="Mean Jan-July precipitation reconstruction from multispecies tree-ring data for the Southwest Mountains of New Mexico. This model assumes negative exponential biological growth, a piecewise linear climate relationship with unknown breakpoints for each species, and stably fluctuating climate (normal distribution).", echo=FALSE, out.width="75%"}

library(knitr)
include_graphics("Results/Figures/NM/negexp_1change_paper.png")
```


```{r, echo=FALSE, results = "asis"}
library(knitr)
nm_stats <- read.csv("Results/NM/nm_performance_stats.csv", header = TRUE, stringsAsFactors = FALSE)
knitr::kable(nm_stats, caption = "Summary statistics of New Mexico (29-04) held out validation data.")
```
